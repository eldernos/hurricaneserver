...
var nicEditor = bkClass.extend({
    ...
    selectCheck : function(e,t) {
        ...
        do{
            try
            {
                if(t.className.indexOf('nicEdit') != -1) {
                    return false;
                }
            }
            catch(e)
...
var nicEditorInstance = bkClass.extend({
    ...
    construct : function(e,options,nicEditor) {
        ...
        if(isTextarea || this.options.hasPanel) {
            ...
            var s = {width: newX+'px', border : '1px solid #ccc', borderTop : 0, overflowY : 'auto', overflowX: 'auto' };
            s[(ie7s) ? 'height' : 'maxHeight'] = (this.ne.options.maxHeight) ? this.ne.options.maxHeight+'px' : null;
            this.editorContain = new bkElement('DIV').setStyle(s).appendBefore(e);
            var editorElm = new bkElement('DIV').setStyle({width : (newX-24)+'px', margin: '4px', minHeight : (newY-26)+'px'}).addClass('main').appendTo(this.editorContain);
